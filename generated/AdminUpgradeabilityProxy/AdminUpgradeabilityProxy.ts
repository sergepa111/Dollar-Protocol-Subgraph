...
export class AdminUpgradeabilityProxy extends ethereum.SmartContract {
  static bind(address: Address): AdminUpgradeabilityProxy {
    return new AdminUpgradeabilityProxy("AdminUpgradeabilityProxy", address);
  }
